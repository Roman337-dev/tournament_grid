...
const All1x1=({setType})=>{
    ...
    const Submit = async(e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/auth/user/create/tournament/1x1/All', {
                name,
                game,
                num_of_part,
                date,
...
return(
        ...
        <h1>Форма для Турнира 1x1 для всех</h1>
        <hr></hr>
...
<label for="num_of_part"><b>Максимальное кол-во человек</b></label>
        <input type="text" id="num_of_part" 
        placeholder="Количесвто людей"
        value={num_of_part} 
